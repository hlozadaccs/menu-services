PROTO_SRC=protos
PROTO_GEN_PYTHON=interfaces/grpc/generated
...
proto-gen:
	...
	@if [ -f "$(PROTO_GEN_PYTHON)/menu_pb2_grpc.py" ]; then \
		sed -i.bak 's/^import menu_pb2/from interfaces.grpc.generated import menu_pb2/' $(PROTO_GEN_PYTHON)/menu_pb2_grpc.py; \
